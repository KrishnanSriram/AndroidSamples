...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.AgentViewHolder> {
    ...
    public void onBindViewHolder(AgentViewHolder agentViewHolder, int i) {
        ...
        if(mAgents.get(i).isMyAgent) {
            ...
            agentViewHolder.descriptionText2.setVisibility(View.VISIBLE);
            agentViewHolder.descriptionText3.setVisibility(View.VISIBLE);
        } else {
//            agentViewHolder.descriptionText2.setVisibility(View.INVISIBLE);
//            agentViewHolder.descriptionText3.setVisibility(View.INVISIBLE);
        }
