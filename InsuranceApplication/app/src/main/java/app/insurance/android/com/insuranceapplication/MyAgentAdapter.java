...
public class MyAgentAdapter extends RecyclerView.Adapter<MyAgentAdapter.AgentViewHolder> {
    ...
    MyAgentAdapter(List<Agent> agents){
        this.mAgents = agents;
    }
    ...
    public AgentViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.my_agent_item, viewGroup, false);
