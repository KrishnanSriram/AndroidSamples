...
public class OtherAgentsAdapter extends RecyclerView.Adapter<OtherAgentsAdapter.AgentViewHolder> {
    ...
    @Override
    public OtherAgentsAdapter.AgentViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.other_agents_list, viewGroup, false);
        OtherAgentsAdapter.AgentViewHolder pvh = new OtherAgentsAdapter.AgentViewHolder(v);
        return pvh;
    }

    @Override
    public void onBindViewHolder(OtherAgentsAdapter.AgentViewHolder agentViewHolder, int i) {
